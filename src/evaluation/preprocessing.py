...
def prepare_dataset(data_file: str, model_name: str = bertje_name) -> SpanDataset:
    sample_list = read_file(data_file)
    print("Getting tokenizer...")
    tokenizer = create_tokenizer(model_name)
    print("Tokenizing data...")
    return SpanDataset(tokenize_compacts(tokenizer, sample_list))
